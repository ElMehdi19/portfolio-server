...
class Projects(Resource):
    ...
    def __init__(self):
        ...
        self.reqparse.add_argument('description', type=str, location='json', default="")
        self.reqparse.add_argument('stack', type=list, required=True, location='json')
        self.reqparse.add_argument('links', type=dict, location='json', default={})
